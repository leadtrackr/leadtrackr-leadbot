...
// ISO 3166-1 alpha-2 → international calling code (no leading +).
const DIAL: [string, string][] = [
  ...
  ['IR', '98'], ['IS', '354'], ['IT', '39'], ['JE', '44'], ['JM', '1876'],
  ['JO', '962'], ['JP', '81'], ['KE', '254'], ['KG', '996'], ['KH', '855'],
  ['KI', '686'], ['KM', '269'], ['KN', '1869'], ['KP', '850'], ['KR', '82'],
  ['KW', '965'], ['KY', '1345'], ['KZ', '7'], ['LA', '856'], ['LB', '961'],
  ...
  ['MO', '853'], ['MP', '1670'], ['MQ', '596'], ['MR', '222'], ['MS', '1664'],
  ...
  ['PK', '92'], ['PL', '48'], ['PM', '508'], ['PR', '1787'], ['PS', '970'],
  ...
  ['ST', '239'], ['SV', '503'], ['SX', '1721'], ['SY', '963'], ['SZ', '268'],
  ...
  ['VA', '39'], ['VC', '1784'], ['VE', '58'], ['VG', '1284'], ['VI', '1340'],
